...
int main(int argc, char* argv[])
{
	...
	//all other process must first is done.
	//my_rank the other process send it 
	//each process send his rank and then it will be summ all send data and save it in reduction_result
	//then send it to root_rank.
	//and the rank 0 is enter 
